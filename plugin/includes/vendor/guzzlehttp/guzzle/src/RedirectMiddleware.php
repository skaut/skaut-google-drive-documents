...
use Sgdd\Vendor\GuzzleHttp\Exception\BadResponseException;
use Sgdd\Vendor\GuzzleHttp\Exception\TooManyRedirectsException;
 ...
 * {@see \Sgdd\Vendor\GuzzleHttp\Middleware::redirect()}.
 *
 * @final
 */

...
use Sgdd\Vendor\Google\Auth\FetchAuthTokenCache;
use Sgdd\Vendor\Google\Auth\Middleware\AuthTokenMiddleware;
use Sgdd\Vendor\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use Sgdd\Vendor\Google\Auth\Middleware\SimpleMiddleware;

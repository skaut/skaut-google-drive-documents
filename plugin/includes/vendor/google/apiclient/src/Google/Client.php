...
use Sgdd\Vendor\Google\Auth\ApplicationDefaultCredentials;
use Sgdd\Vendor\Google\Auth\Cache\MemoryCacheItemPool;
use Sgdd\Vendor\Google\Auth\CredentialsLoader;
use Sgdd\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use Sgdd\Vendor\Google\Auth\OAuth2;
use Sgdd\Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use Sgdd\Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use Sgdd\Vendor\GuzzleHttp\Client;
use Sgdd\Vendor\GuzzleHttp\ClientInterface;
use Sgdd\Vendor\GuzzleHttp\Ring\Client\StreamHandler;
use Sgdd\Vendor\Psr\Cache\CacheItemPoolInterface;
use Sgdd\Vendor\Psr\Http\Message\RequestInterface;
use Sgdd\Vendor\Psr\Log\LoggerInterface;
use Sgdd\Vendor\Monolog\Logger;
use Sgdd\Vendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Sgdd\Vendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;

...
namespace Sgdd\Vendor\Monolog;

use Sgdd\Vendor\Monolog\Handler\HandlerInterface;
use Sgdd\Vendor\Monolog\Handler\StreamHandler;
use Sgdd\Vendor\Psr\Log\LoggerInterface;
use Sgdd\Vendor\Psr\Log\InvalidArgumentException;
use Sgdd\Vendor\Exception;
